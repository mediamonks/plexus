...
export default class RawDataTargetDataSourceBehavior extends DataSourceBehavior implements ITargetDataSourceBehavior {
	...
	async read(): Promise<typeof RawDataTargetDataSourceBehavior.OutputData> {
	...
	async query({ filter, limit, fields, sort }: typeof StructuredDataSourceBehavior.QueryParameters = {}): Promise<typeof RawDataTargetDataSourceBehavior.OutputData> {
